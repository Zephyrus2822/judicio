...
createRoot(document.getElementById('root')).render(
  <StrictMode>
    {/* nav bar er code */}
    <Navigation />   
    {/* body part er code - tailwind lagano ache edit korle samle- ja edit korar text wagera sob ekhan theke.
    ar jodi aurora te kichu change korte lage then change .jsx file + tailwind config    */}
    <AuroraBackground>
      <motion.div
